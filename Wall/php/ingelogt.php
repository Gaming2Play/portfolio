...
<div class="topnav" id="myTopnav">
    ...
    <a href="../php/toevoegen.php">Foto toevoegen</a>
    <a href="../php/about2.php">About</a>
    <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
</div>
<div class="wrapper">
<?php
$mysqli = mysqli_connect('localhost', 'c225224484_db', '123456' , 'c225224484_db') or die("Niffauw");
$query = "SELECT * FROM plaatjes";

$result = mysqli_query($mysqli, $query) or die ('gaat niet goed');
...
//    echo '<img class="plaatjes" src="php/' . $locatie . '" />';
    ...
    echo "<button class='button' id='modalBtn".$id."'> <img class='plaatjes' src='".$locatie."'></img> </button>";
 ...
 <div class='modal-content'>
  ...
  <img class='plaatje_groot' src='".$locatie."'/><br>
  <p>" . $omschrijving ."</p>
</div>
