...
function instruction9() {
    var description = "Voeg buttons toe en klik erop en dan komt een melding.";
    var result = "<img id='verplaatsPlaatje' style='width: 200px;' src='photo.jpg' alt=''><br><button onclick='document.getElementById(\"verplaatsPlaatje\").style.cssFloat = \"left\"; alert(\"left\");'>links</button><button onclick='document.getElementById(\"verplaatsPlaatje\").style.cssFloat = \"right\"; alert(\"right\");'>rechts</button>";
